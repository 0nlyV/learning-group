...
11. Check a narrow viewport, light appearance, dark appearance, and reduced-motion preference. On web, Android, and iOS, confirm that both inline previews remain bounded with no internal vertical scrolling and that the full Portal and journey interfaces scroll only in Expanded Mode.
