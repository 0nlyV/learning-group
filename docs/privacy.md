...
Journey and progress data is retained in Devvit Redis while needed to restore the experience for its associated Reddit posts and installation. Reddit or Devvit may also apply platform-level retention and deletion practices.

To ask about Learning Group data associated with your Reddit username, contact [u/EternalZoe](https://www.reddit.com/user/EternalZoe/) and identify the relevant journey post. Requests will be assessed using the controls available through Reddit's Developer Platform. Deleting a Reddit account, post, community, or app installation may be subject to Reddit's own processes and does not necessarily provide the app with an immediate deletion event.
